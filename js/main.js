...
function load_examples_image() {
    ...
    $tiles_video_examples.append('<li style="width: 360px"> <div class="video"><img src="imgs/youtube-placeholder.jpg"><iframe width="360" height="305" frameborder="0" src="https://www.youtube.com/embed/EVnxkfA6M7Y"></iframe><button type="button" style="margin:10px 0;" onclick="parse_example_video(&quot;https://www.youtube.com/watch?v=EVnxkfA6M7Y&quot;);return false;" class="btn btn_small">Detect</button></div></li>');
